...
def load_documents():
    ...
    return pdf_document, web_document


def create_chunks():

    pdf_document, web_document = load_documents()
...
def display_document_stats(docs, name):
    ...
    if docs:
        ...
        print(
            f"Content (first 150 chars): "
            f"{example_doc.page_content[:150]}..."
        )
...
if __name__ == "__main__":
    ...
    chunks_1, chunks_2 = create_chunks()
